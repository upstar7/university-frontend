            ...
            <div>
                <div className=" bg-white p-2 xl:p-12 rounded-[34px]">
                    <div className="flex flex-row w-full justify-between items-center py-5 my-3 gap-3">
                        <p className=" text-3xl text-black font-bold">University</p>
                        <NavLink to="createUniversity">
                            <Button className="  h-[60px] bg-[#280559] rounded-2xl flex flex-row items-center">
                    ...
                    <div className=" justify-between py-5 my-3 gap-3 grid grid-cols-1 xl:grid-cols-5">
                        ...
                        <div className="flex flex-row gap-4 justify-between col-span-1">
