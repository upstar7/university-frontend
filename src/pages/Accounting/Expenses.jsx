...
export function Expenses() {
   const [expstate, setExpstate]=useState(true);
    return (
        <>
    <div className={`mt-[30px] w-full bg-[#E8E9EB] flex flex-col gap-8 ${expstate?"":"hidden"}`}>
            <div>
            <div className=" bg-white p-2 xl:p-12 rounded-[34px] ">
                    <div className=" w-full flex flex-row justify-between py-5 my-3 gap-4">
                        <p className="text-[32px] font-bold">Expenses</p>
                            <Button className=" h-[60px] bg-[#280559] rounded-2xl flex flex-row justify-center items-center"  onClick={() => setExpstate(false)}>
...
{/* // --------------------------------------------- */}
        ...
        <div className={`mt-[30px] w-full bg-[#E8E9EB] flex flex-col gap-8 ${expstate?"hidden":""}`}>
            ...
            <div>
                ...
                <Button className="bg-[#280559]  rounded-[15px]"  onClick={() => setExpstate(true)}>
