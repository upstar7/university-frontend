    ...
    return (
        <div className="mt-12 w-full bg-[#E8E9EB]">
            ...
            <div className="bg-white rounded-[34px] p-[39px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 laptop:grid-cols-3 gap-[30px] mb-14">
                    <div>
                ...
                <div>
                    <div className=" flex flex-row gap-[90px]  ">
                        ...
                        <div className="flex flex-col justify-center">
                            <img className="mb-3"  src={universityLogo} alt='...'/>
                            <FileUploader
                            multiple={true}
                ...
                <div className="grid grid-cols-1 laptop:grid-cols-3 gap-[30px] mb-14">
                    <div>
                    ...
                    <div >
                        ...
                        <button className=" text-[#BEBFC3] h-[57px]" > Click to add more field  </button>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-[34px] p-[39px] my-[30px] ">
                ...
                <div className="gap-[20px] grid grid-cols-1 xl:grid-cols-2">
            ...
            <NavLink to="leads">
                <Button className="bg-[#280559]  rounded-[15px] left-2 ">
                    <div className="flex flex-row justify-center items-center px-[33px] py-[10px]">
